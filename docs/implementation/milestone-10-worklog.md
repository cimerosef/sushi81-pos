...
## Entry 2026-09-20 — `M10-FINAL-ACCEPTANCE-DOCUMENTATION-CLOSURE-26`

- Authorization/gate state: Issue #4 is OPEN and points to PR #22 / branch `codex/m10-catalogue-xlsx-authorized`; this handoff starts at the accepted polish-25 head `34e61c67785aa6c8c0ca84a545e31de30b17ac39`. The handoff is documentation/governance closure only. No production or test behavior changes, artifact regeneration, merge, M11, M12 or M13 work is authorized.
- Owner acceptance state: A–L functional acceptance is PASS; Scenario I is PASS by accepted prior/manual evidence reuse rather than a fresh computer-B replay; final-delivery Excel bulk-paste ergonomics and responsive Preview layout are PASS in owner comment `5750016695`. No further owner manual testing is required for M10.
- Closure reconciliation: `implementation-status.md` now records M10 as closure-ready; `milestone-10-final-manual-acceptance.md` records the completed owner checklist, accepted candidate and exact evidence. Historical failures and repairs remain preserved in this ledger and the PR discussion.
- Accepted runtime candidate (preserved without regeneration): EXE `artifacts/m10-win-x64-final-polish-p25/Sushi81.Pos.Desktop.exe`, 162,816 bytes, SHA-256 `FD49066E245837F8664C76B48D8978405E5A2457BC859FB6C8C734B456192A82`; ZIP `artifacts/m10-win-x64-final-polish-p25.zip`, 69,962,650 bytes, SHA-256 `A53C639C84709274F56019F4B11FCE3AE58F10258174614FE7030912A3676AA2`.
- Accepted evidence carried forward from the tracked runtime head: focused workbook protection/paste **20/20**; focused STA/WPF Preview **1/1** across 640×480, 940×700 and 1280×900 in fr-FR/zh-CN; full Release solution **787/787**; Release build **0 warnings / 0 errors**; exact-head CI run `35512075546`, job `106081601962`, **SUCCESS**; forbidden-data scan clean.
- Delivery boundary: PR #22 remains OPEN/unmerged pending final controller closure and separate explicit owner merge approval. The matching `CODEX_DONE` completes this documentation handoff only; it authorizes no later work package or milestone.
