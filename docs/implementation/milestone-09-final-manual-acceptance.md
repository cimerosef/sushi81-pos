...
**Accepted build/head:** Not accepted: after checklist A’s reset defect was remediated, owner checklists A–E passed on replacement candidate `a18cca2ad51d3676bc9fc2a99d416ad82a1f1a7a`, but checklist F found that a payment-only modification can clear an active manual authoritative total on a discounted order. The replacement remediation candidate head and artifact hashes will be authoritative in the matching durable `CODEX_DONE: M09-MANUAL-F-MANUAL-TOTAL-PAYMENT-PRESERVATION-FIX-13` record on PR #17.
...
The owner verified candidate `18ec621d077c1da61994e1cb8657ddb67ab752eb` and found that an unresolved parse left **Réinitialiser / réimporter** disabled after returning to Caisse. That defect was remediated by `M09-MANUAL-A-HIBOUTIK-RESET-ENABLEMENT-FIX-12`, after which owner checklists A–E passed on replacement candidate `a18cca2ad51d3676bc9fc2a99d416ad82a1f1a7a`. Checklist F then found that changing only cumulative CB on a discounted order with an active manual total incorrectly repriced the order and cleared the manual override. The active remediation `M09-MANUAL-F-MANUAL-TOTAL-PAYMENT-PRESERVATION-FIX-13` is limited to preserving the persisted sale-time line snapshot for unchanged lines so non-price-affecting edits remain non-price-affecting, plus focused regression evidence and a replacement publish. The owner, not Codex, must resume acceptance on the replacement candidate; all existing checkboxes and final disposition remain unchecked.
