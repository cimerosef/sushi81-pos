...
**Status/boundaries:** WP8 remains **In progress pending ChatGPT re-review**. WP7 proof repository was not rerun or mutated. WP9 broad integration/closure, project-owner manual acceptance, M08 and merge remain not authorized/not started. New-head focused/full Release, build, publish and exact-head CI evidence will be appended after execution.
