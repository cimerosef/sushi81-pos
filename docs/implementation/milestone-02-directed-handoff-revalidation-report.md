...
- Test-complete code head: `0e5938d1f3fd7d7bc0af6bf2f25eed31759a01dc` (the final evidence/status commit follows this code head).
...
The automated tests cover each row with synthetic failure injectors; the corrected full solution result is 118 passed, 0 failed and 0 skipped.
