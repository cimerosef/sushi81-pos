...
- Evidence-closure documentation head: `ed73fc99e77fed79e36707126ec3fda4ff2388c1`.
...
GitHub Actions Continuous integration remains the authoritative per-head CI record. The closure head `ed73fc99e77fed79e36707126ec3fda4ff2388c1` was pushed successfully; at the time of this update its run number/conclusion was not yet exposed by the connected checks API.
