...
**Phase 6 implementation active: M01–M09 Passed/merged; the independent post-M09 Hiboutik daily CB/Espèce dashboard enhancement is Passed/merged; M10 preparation is complete and ready for separate implementation authorization.**
...
M10 — Catalogue `.xlsx` import/export — is now **Preparation complete / ready for separate project-owner implementation authorization** on draft preparation PR #20. The project owner approved the Category `short_code` workbook semantics on 2026-09-17. That decision is frozen in `decisions/m10-category-short-code-workbook-semantics.md`, aligned into `catalogue-management.md`, and registered in `acceptance-criteria-amendment-m10-category-short-code-workbook.md`. M10 implementation remains NOT AUTHORIZED; Issue #4 remains CLOSED with no executable handoff; M11+ remain unauthorized.
...
- `implementation/milestone-10-catalogue-xlsx.md` — prepared non-executable implementation contract;
