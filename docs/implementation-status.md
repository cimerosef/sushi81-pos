...
| M06 — Local recovery/read-only enforcement | In progress | Authorized by `CODEX_HANDOFF_READY: M06-IMPLEMENT-01` on PR #11 / `codex/m06-local-recovery-read-only`; implementation and manual-acceptance evidence are in progress. |
