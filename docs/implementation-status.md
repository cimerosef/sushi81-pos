...
**Current state:** M01 through M07 are Passed and merged. M08 — Printing and reprinting — is **AUTHORIZED** by explicit project-owner approval on 2026-09-12. Execution may begin only after the dedicated M08 branch/PR/mailbox and one valid `CODEX_HANDOFF_READY` are cross-verified and Issue #4 is OPEN. M09 and later milestones remain unauthorized.
...
| M08 — Printing and reprinting | Authorized | Preparation/readiness complete; exact authorized preparation head `b983efa7ef4e2591575fa662f9d433652b97e4aa`; owner layout/receipt-identity decision frozen; execution setup is being established. Merge is not authorized. |
...
Authorization does not authorize merge. M08 still requires implementation evidence, ChatGPT controller review/remediation, exact-head CI, project-owner real Windows/WPF/printing acceptance and separate explicit merge approval.
