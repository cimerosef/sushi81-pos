...
{
    public static IReadOnlyList<SqliteMigration> All { get; } = M01Migrations.All.Concat(M03Migrations.All).Concat(M04Migrations.All).Concat(M05Migrations.All).Concat(M08Migrations.All).ToArray();
}
